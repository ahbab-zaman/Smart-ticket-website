...
rowBtn1.addEventListener("click", function () {
  rowBtn1.style.backgroundColor = "yellow";
  rowBtn1.style.text = "white";
  ...
  let totalPriceText = getAllElementsId('total-price');
  initialSeatNumber++;
  totalSeatNumber--;
...
rowBtn2.addEventListener("click", function () {
  rowBtn2.style.backgroundColor = "yellow";
  rowBtn2.style.text = "white";
...
rowBtn3.addEventListener("click", function () {
  rowBtn3.style.backgroundColor = "yellow";
  rowBtn3.style.text = "white";
...
rowBtn4.addEventListener("click", function () {
  rowBtn4.style.backgroundColor = "yellow";
  rowBtn4.style.text = "white";
